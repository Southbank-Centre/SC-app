...
/**
 * @ngdoc controller
 * @name wowApp.controller:TwitterFeedCtrl
 * @controller
 *
 * @description
...
angular.module('wowApp')
  .controller('TwitterFeedCtrl', function($scope, $rootScope, $http) {
      ...
      .success(function(data) {
      	...
      	if (!data.errors) {
	      	...
	      	angular.forEach($scope.tweets, function(tweet, i) {
	      		...
	      		$scope.tweets[i].created_at = moment(tweet.created_at).fromNow();
