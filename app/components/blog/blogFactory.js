...
angular.module('wowApp')
  .factory('blogFactory',[
    ...
    '$rootScope',
    'utilitiesFactory',
    function($http, $rootScope, utilitiesFactory) {
      ...
      return {
        ...
        getBlogList: function(callbackSuccess, callbackError) {
          ...
          var requestString = 'json/node.json?type=blog_post&status=1&sort=field_published_date&direction=DESC&field_festival=' + $rootScope.festivalId;
